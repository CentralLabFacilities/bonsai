...
public interface WorkingMemory extends ManagedCoreObject {
     ...
     *
     * @param slotName A unique identifier for the information that should be stored
     *                 or accessed.
     * @param dataType The type of the data that should be stored or accessed.
     ...
     * @throws IllegalArgumentException    When the configuration of the working memory does not allow
     *                                     to create the desired slot.
     * @throws CoreObjectCreationException When an error occurred while creating the requested slot.
     */
