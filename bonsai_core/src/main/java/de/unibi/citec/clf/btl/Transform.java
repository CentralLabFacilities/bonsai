...
public class Transform {
     ...
     *
     * @param transform   The transform itself as Java3D {@link Transform3D}
     * @param frameParent The parent coordinate frame ID
     * @param frameChild  The child coordinate frame ID
     * @param time        The time at which this object was created.
     */
     ...
     *
     * @param transform The transform as Java3D {@link Transform3D}
     */
     ...
     *
     * @param frameParent The frame ID.
     */
