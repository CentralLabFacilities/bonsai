...
public interface ConfigurationParser {
     ...
     * @throws IOException           error opening the file for parsing
     * @throws ParseException        error parsing the file
     * @throws IllegalStateException if parsing was already invoked
     */
