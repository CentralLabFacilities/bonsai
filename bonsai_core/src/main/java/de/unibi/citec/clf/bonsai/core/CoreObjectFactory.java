...
public interface CoreObjectFactory {
     ...
     * method invoked
     *
     * @param options options provided by the user as key-value-pairs.
     * @throws IllegalArgumentException this exception may be thrown to indicate an error in the
     ...
     * @throws InitializationException  a general error initializing this factory occurred. It cannot
     ...
     * @throws IllegalArgumentException    error in the configuration provided by the use
     * @throws CoreObjectCreationException error connecting one of the requested sensors
     */
     ...
     * @throws IllegalArgumentException    error in the configuration provided by the use
     * @throws CoreObjectCreationException error connecting one of the requested actuators
     */
     ...
     * @throws IllegalArgumentException    error in the configuration provided by the use
     * @throws CoreObjectCreationException error connecting one of the requested memories
     */
     ...
     *
     * @param value transformers
     * @throws IllegalArgumentException    error in the configuration provided by the use
     * @throws CoreObjectCreationException error creating the transformer
     */
     ...
     * @param key      key under which the sensor was registered at a call to
     *                 {@link #configureSensors(Set)}
     * @param dataType class object representing the data type of the sensor to
     *                 create
     * @return new instance of the sensor
     * @throws IllegalArgumentException    there is no sensor for the given data type with the provided
     *                                     key
     ...
     * @param key      key under which the sensor was registered at a call to
     *                 {@link #configureSensors(Set)}
     * @param listType class object representing the list type of the sensor to
     *                 create
     * @param dataType class object representing the data type of the sensor to
     *                 create
     * @return new instance of the sensor
     ...
     *
     * @param <T>           type of the actuator to create (minimally implemented
     *                      interface)
     * @param key           key under which the actuator was registered at a call to
     ...
     * @param actuatorClass interface that the actuator to create must minimally fulfill
     ...
     * @throws IllegalArgumentException    there is no working memory for the given type with the
     *                                     provided key
     * @throws CoreObjectCreationException error while creating the requested working memory
     */
     ...
     * @throws CoreObjectCreationException error while creating the requested coordinate transformer
     */
