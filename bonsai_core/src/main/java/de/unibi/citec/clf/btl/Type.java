...
public abstract class Type {
	 ...
	 * @throws NoSourceDocumentException
	 *             Is thrown if this object was created manually and not parsed
	 ...
	 *            The document from which this object was parsed.
	 */
	 ...
	 * 
	 * @param timestamp
	 *            The timestamp as a long value unix time.
	 */
