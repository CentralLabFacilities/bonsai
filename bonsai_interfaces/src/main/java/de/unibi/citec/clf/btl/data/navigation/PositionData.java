 ...
 */
public class PositionData extends Point2D {
     ...
     */
    public PositionData(double x, double y, double yaw, Timestamp timestamp,
    ...
    public PositionData(double x, double y, double yaw, long timestamp,
    ...
    public PositionData(double x, double y, double yaw,
            LengthUnit lU, AngleUnit aU) {
        this.x = UnitConverter.convert(x, lU, iLU);
        this.y = UnitConverter.convert(y, lU, iLU);
        this.yaw = UnitConverter.convert(yaw, aU, iAU);
     ...
     */
    public double getDistance(Point2D otherPosition, LengthUnit lU) {
     ...
     * @param lU desired length unit
     */
    public double getDistance(PositionData otherPosition, LengthUnit lU) {
        double dx = getX(lU) - otherPosition.getX(lU);
        double dy = getY(lU) - otherPosition.getY(lU);
        return Math.sqrt(Math.pow(dx, 2) + Math.pow(dy, 2));
    }

    public double getGlobalAngle(PositionData otherPosition, AngleUnit unit) {
    ...
    public double getRelativeAngle(PositionData otherPosition, AngleUnit unit) {
